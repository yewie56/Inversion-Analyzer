...
rem ============================================================
rem Inversion Analyzer v0.15.25 - safe GitHub uploader
rem ASCII file: no UTF-8 BOM.
rem
rem Put this BAT next to Inversion_Analyzer_v0.15.25.zip
rem and start it from Anaconda Prompt / PowerShell.
rem ============================================================

set "EXPECTED_VERSION=0.15.25"
set "EXPECTED_REMOTE=yewie56/Inversion-Analyzer"
set "ZIP=%~1"
if not defined ZIP set "ZIP=%~dp0Inversion_Analyzer_v0.15.25.zip"
set "REPO=%~2"
set "TMP=%TEMP%\InversionAnalyzer_v%EXPECTED_VERSION%_%RANDOM%_%RANDOM%"
set "COMMITMSG=Release v%EXPECTED_VERSION% - pending ratings handling"
...
python test_supabase_ratings_sync_v0_15_25.py
if errorlevel 1 (
  set "TESTNAME=test_supabase_ratings_sync_v0_15_25.py"
  goto :test_failed
)
python test_supabase_ratings_workflow_v0_15_25.py
if errorlevel 1 (
  set "TESTNAME=test_supabase_ratings_workflow_v0_15_25.py"
  goto :test_failed
)
python test_gui_kit_reference_remote_v0_15_23.py
if errorlevel 1 (
  set "TESTNAME=test_gui_kit_reference_remote_v0_15_23.py"
  goto :test_failed
)
